...
#
#ident  "@(#)minimal-SunFire_Domain-X-Solaris8.profile 1.2     04/03/16     SMI"
#
...
package SUNWxildh   add      # XIL Loadable Pipeline Libraries
package SUNWxilow   add      # XIL Deskset Loadable Pipeline Libraries
package SUNWxilrl   add      # XIL Runtime Environment
package SUNWxwfnt   add      # X Window System platform required fonts
package SUNWxwopt   add      # X Window System Optional Clients

# Sun VTS (requires X common)
